	...
	unsigned long **bit, int *max)
{
	...
	if (HID_UP_CONSUMER == (usage->hid & HID_USAGE_PAGE)) {
		...
		/* report 2 */
		/* MENU */
		case 0x040: samsung_kbd_mouse_map_key_clear(KEY_PHONE); break;
		...
		case 0x223: samsung_kbd_mouse_map_key_clear(KEY_MENU); break;
		/* RECENTAPPS */
		case 0x301: samsung_kbd_mouse_map_key_clear(KEY_F14); break;
		/* APPLICATION */
		case 0x302: samsung_kbd_mouse_map_key_clear(KEY_DASHBOARD); break;
		/* Voice search */
		case 0x305: samsung_kbd_mouse_map_key_clear(KEY_PROG2); break;
		/* QPANEL on/off */
		case 0x306: samsung_kbd_mouse_map_key_clear(KEY_F13); break;
		/* SIP on/off */
		case 0x307: samsung_kbd_mouse_map_key_clear(KEY_PROG1); break;
		/* LANG */
		case 0x308: samsung_kbd_mouse_map_key_clear(KEY_HANGEUL); break;
